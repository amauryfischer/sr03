...
public class commentsDao {
	...
	public static List<comment> getComments(String ideaId) {
		List<comment> lu = new ArrayList<comment>();
		...
		try {
			...
			String sql = "SELECT id, scientist_id, date, idea_id, content FROM comments WHERE idea_id="+Integer.parseInt(ideaId);
			PreparedStatement ps = cnx.prepareStatement(sql);
